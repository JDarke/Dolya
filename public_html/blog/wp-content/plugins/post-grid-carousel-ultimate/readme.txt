...
6. Filterable Grid 
7. Widget
8. Backend: All Grid/Carousel
9. Backend: New Grid/Carousel
10. Backend: General Settings
11. Backend: Carousel Settings
12. Backend: Grid Settings
13. Backend: Shortable Grid Settings
14. Backend: Style Settings
...
= 1.3.2 =
* Remove: Global font and font size
= 1.3.1 =
...
* Fix: Style related issues
= 1.2.0 =
* Added support for Directorist and WP Adverts plugins
= 1.1.1 =
* Tweak: improved some code
= 1.1.0 =
* Added: Read more background color
* Fixed: Design related issues
= 1.0.2 =
* Fixed: Category related issues
= 1.0.1 =
* Made the plugin styles compatible with any themes
= 1.0.0 =
* Initial release
